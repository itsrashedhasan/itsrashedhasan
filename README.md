...
**[🏥 MedGuide AI](https://github.com/itsrashedhasan/medguide-ai)**
> Multimodal medical chatbot — LLM triage, medical imaging, voice interaction (EN + BN)

`FastAPI` `Groq LLM` `Whisper` `HuggingFace` `PostgreSQL`
...
**[🏠 StayHub](https://github.com/itsrashedhasan/StayHub)**
> Housing marketplace for Bangladesh with KYC verification and booking escrow

`Laravel 12` `PHP` `MySQL` `Livewire` `Tailwind`

</td>
<td>

**[📱 Ecom Flutter App](https://github.com/itsrashedhasan/Ecom)**
> Feature-complete Android e-commerce app with cart, checkout, and order tracking

`Flutter` `Dart` `ChangeNotifier` `Android`
